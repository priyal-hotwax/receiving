...
@Component({
  selector: 'app-receive-history-modal',
  templateUrl: './receive-history-modal.page.html',
  styleUrls: ['./receive-history-modal.page.scss'],
})
export class ReceiveHistoryModalPage implements OnInit {
